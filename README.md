...
```bash
git clone https://github.com/MomoFadaly/sme-local-seo.git
```

Or download the zip from [fadaly.net/skills/sme-local-seo](https://fadaly.net/skills/sme-local-seo) (the per-skill landing page on fadaly.net) and extract into `~/.claude/skills/`.
